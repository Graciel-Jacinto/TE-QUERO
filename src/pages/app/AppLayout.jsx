...
export default function AppLayout() {
  ...
  return (
    <>
      {/* ==========================================================
          CSS CRÍTICO — altura adaptativa multi-browser + safe area
      ========================================================== */}
      <style>{`
        /* Shell principal — 7 camadas de proteção */
        .app-shell {
          position: fixed;
          top: 0;
          left: 0;
          right: 0;
          bottom: 0;
          /* Fallbacks em ordem crescente de qualidade */
          height: 100vh;          /* browsers antigos */
          height: 100svh;         /* Chrome 108+, Safari 15.4+ */
          height: 100dvh;         /* melhor: adapta-se ao bar móvel */
          display: flex;
          flex-direction: column;
          overflow: hidden;
          background: #f9fafb;
          overscroll-behavior: none;      /* sem "puxão" iOS */
          -webkit-overflow-scrolling: touch;
          padding-left: env(safe-area-inset-left, 0px);
          padding-right: env(safe-area-inset-right, 0px);
        }

        /* iOS antigo (pré-15.4) — -webkit-fill-available resolve */
        ...
        /* Bottom nav mobile — sempre visível, nunca colapsa */
        .app-bottom-nav {
          min-height: 56px;
        ...
        /* Conteúdo principal — permite scroll interno sem empurrar nav */
        .app-main-scroll {
          min-height: 0;
          -webkit-overflow-scrolling: touch;
        }
      ...
      <div className="app-shell">
        ...
        <div className="flex-1 min-h-0 flex relative">
          ...
          {/* ---------- CONTEÚDO ---------- */}
          <main className="flex-1 min-h-0 relative overflow-hidden app-main-scroll">
            {isDiscover ? (
              <Outlet />
            ) : (
        ...
        {/* ============ BOTTOM NAVBAR (mobile) — reforçado ============ */}
